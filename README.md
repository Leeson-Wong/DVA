...
DVA 是一个软件设计分析工具。帮你在写代码之前想清楚：**需求变了，你的代码只改一个地方就能跟上，而不是牵一发动全身。**
...
不是所有 23 个模式都纯粹是外化。Singleton 管实例数量约束，Flyweight 管内存优化，Interpreter 管语法表达——它们各有各的动机。DVA 能解释大部分模式从何而来，但不应强行解释全部。
